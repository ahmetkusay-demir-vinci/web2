...
function parse(filePath, defaultArray = []) {
  if (!fs.existsSync(filePath)) return defaultArray;    //Le chemin vers le fichier JSON existe pas , on renvoie la liste par défaut ( tableau vide )
...
/*On souhaite que notre fichier JSON qui contiendra les pizzas soit repris dans le répertoire /data */ 
